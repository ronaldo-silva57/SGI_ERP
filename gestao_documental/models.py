...
class Documento(models.Model):
    ...
    tipo_norma = models.CharField(max_length=20, choices=NORMA_CHOICES, default='iso9001')
    ...
    arquivo = models.FileField(upload_to='documentos/', blank=True, null=True)  # CORRIGIDO: added blank and null
    data_elaboracao = models.DateField(auto_now_add=True)  # CORRIGIDO: auto_now_add
